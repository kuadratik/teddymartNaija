...
return new class extends Migration
{
    ...
    {
        DB::table('listing_attributes')->whereNotNull('measurement')->get()->each(function ($attribute) {
            $measurements = json_decode($attribute->measurement, true);
            ...
            DB::table('listing_attributes')->where('id', $attribute->id)->update([

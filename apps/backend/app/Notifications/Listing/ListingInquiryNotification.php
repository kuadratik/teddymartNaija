...
class ListingInquiryNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Customer Inquiry: New Message About Your Product/Service on AfricanDiasporaMart.')
            ->greeting("Dear {$respondentName},")
            ->line('We’re pleased to inform you that a customer has sent you a message regarding one of your products or services on AfricanDiasporaMart.')
            ...
            ->line('')
            ->line('Thank you for your dedication to providing quality service on AfricanDiasporaMart. We look forward to your continued success');
    }

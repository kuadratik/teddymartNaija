...
class OrderPaymentFailedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->priority(1)
            ->subject('Oh no! Payment unsuccessful for AfricanDiasporaMart Order #' . $this->order->order_number)
            ->greeting('Dear ' . $notifiable->first_name . ',')
            ->line('We are sorry to inform you that we were unable to process the payment for your recent order on AfricanDiasporaMart.')
            ...
            ->line('Thank you for choosing AfricanDiasporaMart. We apologize for any inconvenience this may have caused.');
    }

  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        {showBtn && (
          <ButtonWrapper onClick={handleClick} htmlType="button" type="primary" className="">
            {btnText}
          </ButtonWrapper>
        )}{' '}
      </div>
...
const ButtonWrapper = tw(Button)`whitespace-nowrap rounded-lg bg-black px-8 lg:px-20 py-[22px] text-white md:w-[140px]`

                ...
                {storeGroup.products.map((product: any, productIndex: number) => (
                  ...
                  >
                    <div className="h-[40px] w-[40px] overflow-hidden rounded-[9px]">
                      <Image
                        src={`${process.env.imageBaseUrl}/${product?.variant?.image?.[0] || product?.images[0]}`}
                        alt="store-image"
                    ...
                    <div className="flex-1">
                      ...
                      {product.variant && (
                        <TextComponent as="p" className="text-[11px] font-medium text-gray-600">
                          Variant: <span className="font-bold">{product.variant.name}</span>
                        </TextComponent>
                      )}

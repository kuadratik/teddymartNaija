...
const AddVariants = ({
  ...
  const successAction = () => {
    ...
    setSelectedVariant({
      ...
      weight: values?.weight || '', // Prefill with product weight
                  ...
                  <Tooltip
                    title={
                      <p className="font-[500] text-black">
                        Product weight helps determine shipping costs and logistics. Enter the actual weight in grams
                        for accurate calculations and better user experience.
                      </p>
                    }
                    color="white"
                  >
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                    ...
                    if (value === '' || /^[0-9]+\.?([0-9]+)?$/.test(value)) {
                      setSelectedVariant({...selectedVariant, weight: value})
                    }
                  }}

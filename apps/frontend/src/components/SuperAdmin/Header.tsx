  ...
  const userMenuItems: MenuProps['items'] = [
    {
      ...
      onClick: () => {
        ...
        router.push('/super-admin/dashboard/users/profile')
      }
    },
    // {
    //   key: '2',
    ...
    <header className="fixed top-1 z-50 w-full sm:top-2">
      <div className="mx-auto w-full max-w-screen-xl rounded-lg border-b border-gray-100 bg-white px-3 py-2.5 sm:rounded-full sm:px-4 sm:py-3 lg:px-5 2xl:max-w-screen-2xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Mobile Menu Button */}
            <div className="flex h-[36px] w-[36px] items-center justify-center rounded-lg bg-[#F4F4F4] lg:hidden">
              <button
      ...
      >
        ...
        >
          ...
          {/* User Info Section */}
          <Link href="/super-admin/dashboard/users/profile" className="border-b border-gray-100 block px-4 py-4 hover:bg-gray-50">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 underline">
                  {handleShowAdminRole(profileData ? profileData.data.role : 'super_admin')}
                </p>
              </div>
            </div>
          </Link>

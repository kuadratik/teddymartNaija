...
const BrandCard: React.FC<BrandCardProps> = ({ brand, onEdit, onArchive, onViewLink, showArchivedBadge = false }) => {
  ...
  return (
    <div className="rounded-[16px] border border-white bg-white/20 p-3 md:p-6 backdrop-blur-sm transition-shadow hover:shadow-md">
      ...
      <div className="mb-6 flex items-start justify-between">
        ...
        <Dropdown menu={{ items: menuItems }} placement="bottomRight" trigger={['click']}>
          <button title="More options" className="rounded-lg p-1 transition-colors hover:bg-white">

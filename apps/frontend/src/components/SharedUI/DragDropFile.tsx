...
const DragDropFile: React.FC<IProps> = ({
  ...
  console.log("🚀 ~ DragDropFile ~ uploadedFile:", `${process.env.imageBaseUrl}/${uploadedFile}`)
  console.log("🚀 ~ DragDropFile ~ uploadedFile:", `${uploadedFile}`)
  ...
  return (
    <div className="mb-4">
      ...
      >
        ...
        <Image
          src={
            uploadedDetails || uploadedFile
              ? '/assets/admission/file_upload_states.svg'
              : '/assets/admission/Upload.svg'
          }
          width={48}
          height={48}
          alt="upload"
        ...
        {uploadedDetails ? (
          ...
          <div>
            ...
            <div className="mb-2 flex justify-center">
              <Image
                src={uploadedFile ? `${process.env.imageBaseUrl}/${uploadedFile}` : '/assets/default_banner.jpg'}
                width={80}
                height={80}

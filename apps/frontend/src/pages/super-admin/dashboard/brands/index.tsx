...
import {Brand, useArchiveBrandMutation, useGetBrandsQuery, useUnarchiveBrandMutation} from '@/services/super-admin'
      ...
      <SuperAdminLayout>
        ...
        <PermissionGuard permission="manage-brands">
          <>
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="w-full sm:w-auto sm:flex-shrink-0">
                <button
                  ...
                  className="rounded-full bg-black px-10 py-3 text-[14px] font-medium text-white transition-colors hover:bg-gray-800 sm:w-auto md:w-full md:px-6"
                >
                  Add Brand
                </button>
              </div>
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:justify-between md:items-center">
              <div className="flex w-fit items-center justify-center gap-1 rounded-xl bg-white p-1 md:gap-2 md:p-2">
                <button
                  onClick={() => {
                    setActiveFilter('all')
                    setCurrentPage(1)
                  }}
                  className={`min-w-[100px] rounded-lg px-3 py-1.5 text-[13px] font-medium transition-colors md:rounded-xl md:px-5 md:py-2.5 ${
                ...
                <button
                  ...
                  className={`rounded-lg px-3 py-1.5 text-[13px] font-medium transition-colors md:rounded-xl md:px-5 md:py-2.5 ${
                ...
                <div className="w-full sm:w-auto sm:flex-shrink-0">
                  ...
                  <div className="hidden w-full rounded-[8px] border border-gray-200 bg-white py-[3px] shadow-sm transition-colors focus-within:border-black focus-within:ring-1 focus-within:ring-black hover:border-gray-300 sm:block sm:w-[280px]">
                    <DatePicker.RangePicker
                      ...
                      allowClear
                      suffixIcon={
                        <img src="/assets/super-admin/calendar-icon.svg" alt="calendar" className="h-5 w-5" />
                      }
                      style={{
                        width: '100%'
                      }}

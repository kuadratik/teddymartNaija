          ...
          <div className="w-full bg-white font-medium text-black">
            ...
            <div className="px-5 lg:px-0">
              <p className="mt-[13px] text-center text-[14px] leading-[30px] lg:px-40">
                These Terms of Service ("Terms") govern your use of the myeki.market platform ("Service"), operated by
    ...
    '@graph': [
      {
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://myeki.market/search?q={search_term_string}',
      ...
      {
        '@type': 'TermsOfService', // Correct schema type
        name: 'Terms of Service',
        description: 'These Terms of Service govern your use of the myeki.market platform...', // Your description
        url: 'https://myeki.market/terms-of-service', // Correct URL
        provider: {
          // Link to the providing organization
          '@type': 'Organization',
          '@id': 'https://myeki.market' // Use @id to link
        }
      }
    ]
  }

...
const SuccessCheckoutPage = () => {
  ...
  console.log('🚀 ~ SuccessCheckoutPage ~ paymentSuccessCheckoutData:', paymentSuccessCheckoutData)
          ...
          {!paymentSuccessCheckoutData?.length ? (
            ...
            <div className="flex flex-col justify-between gap-4 md:justify-normal lg:mx-auto lg:w-full lg:max-w-7xl">
              <div className="mx-auto mt-[60px] w-full text-center lg:w-[60%] lg:px-5">
                <h3 className="text-[32px] font-bold leading-[31px] text-[#1D1d1d]">Congratulations !!!</h3>
                <p className="pt-8 text-[16px] leading-[20px] text-[#6B7280]">
                  Order <span className="hidden font-bold text-black">number E12BF3C6</span> was successfully placed.{' '}
                  <br />
                                      ...
                                      <div className="flex items-center justify-between">
                                        ...
                                        >
                                          <FormatNumberCurrency
                                            value={
                                              Number(item?.listing_price ?? 0) + Number(product?.shipping_cost ?? 0)
                                            }
                                          />
                                        </TextComponent>
                                      </div>

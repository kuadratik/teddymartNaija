...
const InvoiceView = () => {
  ...
  const {data: userOrderDetails, isSuccess: isOrderDetailsSuccess} = useGetUserOrderDetailsQuery(
    {
      ...
      const formattedData = [
        {
          ...
          store: (userOrderDetails as any)?.data?.store,
          order_details: (userOrderDetails as any)?.data?.order_details,
          shipping_cost: (userOrderDetails as any)?.data?.shipping_cost,
          subtotal: (userOrderDetails as any)?.data?.subtotal
        }
      ]
      setOrderData(formattedData)
    } else if (paymentSuccessCheckoutData) {
      setDataSource('localStorage')
      setOrderData(paymentSuccessCheckoutData)
    }

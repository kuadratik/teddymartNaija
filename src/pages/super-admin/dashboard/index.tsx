    ...
    <>
      ...
      <SuperAdminLayout>
        ...
        <div className="rounded-lg bg-white/30 p-4">
          <TextComponent as="h2" className="mb-4 text-lg font-semibold text-gray-900">
            Main Nav
          </TextComponent>
          ...
          <div className="">
            {navLinks
              ...
              .map(link => (
                ...
                >
                  {/* Main Nav Item */}
                  <div className="flex items-center justify-between rounded-lg px-5 py-4 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                      {/* Path */}
                      <TextComponent as="span" className="rounded-lg bg-white p-2 text-[14px] text-black">
                        {link.path}
                      </TextComponent>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="rounded-full border border-black px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200"
                        >
                          Add sub nav
                        </button>
                      </div>
                    ...
                    <div className="mr-[100px] pr-4">
                      {getSubNavs(link.id).map(subLink => (
                        <div
                          ...
                          className={`flex cursor-move items-center justify-between rounded-lg border-b border-[#E6E6E6] bg-white/50 py-3 pl-12 pr-5 shadow-sm transition-all duration-200 ${subNavDrag.getDragItemClassName(subLink.id)}`}
                        >
                          <div className="flex h-10 items-center gap-3 border-l-[3px] border-black pl-3">
                            <svg
                              width="20"
                              height="20"
                              viewBox="0 0 20 20"
        ...
        {/* Bottom Nav Section */}
        <div className="mb-8 rounded-lg bg-white/30 px-4 pb-4">
          <TextComponent as="h2" className="mb-4 text-lg font-semibold text-gray-900">
            Bottom Nav
          </TextComponent>
          ...
          <div className="">
            {bottomNavLinks.map(link => (
              <div
                ...
                className={`order-b flex cursor-move items-center justify-between rounded-lg border-[#E6E6E6] bg-white/30 px-5 py-4 shadow-sm transition-all duration-200 ${bottomNavDrag.getDragItemClassName(link.id)}`}
              >
                <div className="flex items-center gap-3">

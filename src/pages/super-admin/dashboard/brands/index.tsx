    ...
    <>
      ...
      <SuperAdminLayout>
        ...
        <div className="mb-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
          <div className="flex w-fit items-center justify-center gap-2 rounded-xl border-[8px] border-white">
            <button
              onClick={() => {
                setActiveFilter('all')
                setCurrentPage(1)
              }}
              className={`min-w-[100px] rounded-xl px-6 py-2.5 text-[14px] font-medium transition-colors ${
                activeFilter === 'all' ? 'bg-black text-white' : 'bg-transparent text-black hover:bg-gray-100'
              }`}
            >
              All
            </button>
            <button
              ...
              className={`rounded-xl px-6 py-2.5 text-[14px] font-medium transition-colors ${
                activeFilter === 'archive' ? 'bg-black text-white' : 'bg-transparent text-black hover:bg-gray-100'
              }`}
            >
              Archive
            </button>

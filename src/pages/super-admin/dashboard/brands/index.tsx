  ...
  return (
    <>
      ...
      <SuperAdminLayout>
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="w-full sm:w-auto sm:flex-shrink-0">
            <button
              ...
              className="md:w-full rounded-full bg-black px-10 md:px-6 py-3 text-[14px] font-medium text-white transition-colors hover:bg-gray-800 sm:w-auto"
            >
              Add Brand
            </button>
          </div>
        ...
        <div className="mb-8 flex flex-col md:items-center gap-4 sm:flex-row sm:justify-between">
          <div className="flex w-fit items-center justify-center gap-1 md:gap-2 rounded-xl bg-white p-1 md:p-2">
            <button
              onClick={() => {
                setActiveFilter('all')
                setCurrentPage(1)
              }}
              className={`min-w-[100px] md:rounded-xl rounded-lg px-3 py-1.5 md:px-5 md:py-2.5 text-[13px] font-medium transition-colors ${activeFilter === 'all' ? 'bg-black text-white' : 'bg-[#F2F2F2] text-black hover:bg-gray-100'
                }`}
            >
              All
            </button>
            <button
              ...
              className={`md:rounded-xl rounded-lg px-3 py-1.5 md:px-5 md:py-2.5 text-[13px] font-medium transition-colors ${activeFilter === 'archive' ? 'bg-black text-white' : 'bg-[#F2F2F2] text-black hover:bg-gray-100'
                }`}
            >
              Archive
            </button>
            <button
              ...
              className={`md:rounded-xl rounded-lg px-3 py-1.5 md:px-5 md:py-2.5 text-[13px] font-medium transition-colors ${activeFilter === 'slug-history' ? 'bg-black text-white' : 'bg-[#F2F2F2] text-black hover:bg-gray-100'
                }`}
            >
              Slug History
            </button>
                          ...
                          return (
                            <React.Fragment key={`dots-${page}`}>
                              ...
                              <button
                                ...
                                className={`flex h-9 w-9 items-center justify-center rounded-lg text-[14px] font-medium transition-colors ${page === currentPage
                                  ? 'bg-black text-white'

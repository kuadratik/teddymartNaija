...
const PostAdPage = () => {
  ...
  const [createAdvert, {isLoading: isCreateAdvertLoading}] = useCreateAdvertMutation()
          ...
          >
            ...
            <div className="flex w-full flex-col gap-[34px]">
              ...
              <div className="flex w-full flex-col gap-4">
                <SelectInput
                  placeholder="Ad Type*"
                  data={typeOptions}
                  value={values.type ? typeOptions.find(type => type.value === values.type)?.value : null}
                  onChange={value => {
                    setFieldValue('type', value)
                  }}
                  disabled={false}
                  notFoundContent={'Ad Type not found'}
                  errorMessage={typeof errors.type === 'string' ? errors.type : ''}
                />
                <TextInput
                ...
                <SelectInput
                  ...
                  errorMessage={typeof errors.category_id === 'string' ? errors.category_id : ''}
                />
            ...
            <div className="flex w-full flex-col gap-[34px]">
              ...
              <PlansContainer
                ...
                errorMessage={errors.promote_plan_id}
              />
            </div>

            ...
            <div className="flex flex-col justify-between gap-5">
              ...
              <div className="mt-3 flex flex-wrap gap-5 text-[13px] font-medium text-[#6B7280] md:flex-nowrap">
                ...
                <span className="flex items-center gap-1">
                  ...
                  <a href={`tel:${newFormatPhoneNumberByCountry(`+${data?.data?.business_contact_number ?? ''}`)}`} className="">
                  ...
                  {data?.data?.secondary_contact_number && data?.data?.show_secondary_contact && (
                    <>
                      ,
                      <a href={`tel:${newFormatPhoneNumberByCountry(`+${data?.data?.secondary_contact_number ?? ''}`)}`} className="">

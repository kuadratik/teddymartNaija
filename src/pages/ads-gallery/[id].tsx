...
const AdsGalleryIdPage = ({data: adsInfo, seoData}: any) => {
  ...
  console.log('🚀 ~ AdsGalleryIdPage ~ isWishlisted:', isWishlisted)
        ...
        <div className="px-4">
          ...
          {adsRatedData?.data?.ratings.length! > 0 && (
            <div className="mt-[30px] lg:mt-[55px]">
              <h3 className="relative top-3 text-[20px] font-semibold lg:top-0 lg:pb-5">Ratings</h3>
              <div className="hidden grid-cols-4 gap-3 rounded-lg bg-white p-4 lg:grid">

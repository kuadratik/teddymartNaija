...
import {Dropdown, Menu, Pagination, Tag} from 'antd'
...
import {typeOptions} from '../vendor/dashboard'
      ...
      <main className="">
        ...
        <MainWrapper className="">
          ...
          <div className="flex w-full flex-col">
            <AllCategory open={open} setOpen={setOpen} setSelectedCategories={setSelectedCategories} />
                            ...
                            {typeOptions.map((option, index) => (
                              <p
                                ...
                                onClick={() => {
                                  ...
                                  updateQueryParams({type: option.value})
                                }}
          ...
          <div className="px-4">
            <div className="flex items-center justify-between">
              <TextComponent as="span" className="text-[19px] font-bold capitalize leading-[13px]">
                {capitalizeFirstLetter(type ?? '')} Ads Gallery
              </TextComponent>{' '}
              <Link href="/post-ad" className="rounded-md bg-black px-4 py-3 text-sm font-medium text-white lg:px-8 hover:opacity-80 hover:text-gray-200">
                Post Ad
              </Link>
            </div>
            {tags?.length ? (
              ...
              {isLoading ? (
                ...
                <div className="mx-auto my-[40px] flex flex-col items-center justify-center px-[16px] text-center md:w-[60%]">
                  <p className="flex text-center text-[20px] font-bold">
                    {capitalizeFirstLetter(type ?? '')} Ads loading…
                  </p>
                ...
                <div className="mx-auto my-[40px] flex flex-col items-center justify-center px-[16px] text-center md:w-[60%]">
                  <p className="flex items-center pb-10 pt-1 text-center text-[20px] font-bold opacity-80">
                    No {capitalizeFirstLetter(type ?? '')} Ads found in this category
                  </p>
                </div>
              ) : (
                <></>

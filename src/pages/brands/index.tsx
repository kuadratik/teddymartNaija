...
import {useGetBrandsQuery, useGetBrandCategoriesQuery} from '@/services/brands/brands'
    ...
    <>
      ...
      <BaseLayout className="px-0">
        ...
        <div className="mx-auto w-full max-w-screen-xl lg:mt-8 lg:px-5 xl:px-0 2xl:max-w-screen-2xl">
          <SearchWrapper className="flex w-full max-w-7xl items-center justify-between !px-2 md:gap-3 lg:mx-auto lg:gap-5 lg:!px-5">
            ...
            <div className="relative z-30 w-[120px] sm:w-[200px] lg:!w-[30%] xl:!w-[25%]">
              <SelectInput
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
                {brands.map(brand => (
                  <div
                    ...
                    onClick={() => {
                      // Navigate to brand detail page when implemented
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 border-b border-gray-100 p-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="truncate text-base font-semibold leading-tight text-gray-900">{brand.name}</h3>
                        {(() => {
                    ...
                    <div className="flex items-center justify-between p-4">
                      ...
                      <Tooltip placement="top" title={brand.description}>
                        <p className="max-w-[85%] cursor-pointer truncate text-sm leading-relaxed text-gray-600">
                          {brand.description}
                        </p>
                      </Tooltip>
                      ...
                      <button
                        ...
                        onClick={e => {
                          e.stopPropagation()
                          window.open(brand.target_url, '_blank', 'noopener,noreferrer')
                        }}
                      >

...
import CustomerReview from '../Vendor/components/product/CustomerReview'
import ProductDetailsReview from '../Vendor/components/product/ProductDetailsReview'
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          <div className="flex-shrink-0 lg:w-[400px]">
            ...
            <div className="mt-[10px] grid grid-cols-3 gap-3 md:flex md:gap-2">
              {(currVariant ? productData?.data?.variants[currVariant] : productData?.data)?.images?.map(
                (productIn: any, id: any) => {
                  console.log('currentImageUrl', productIn)
                  return (
          ...
          <ProductClipBox data={productData?.data} />
        </div>

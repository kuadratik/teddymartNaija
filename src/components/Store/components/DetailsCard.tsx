    ...
    <React.Fragment>
      ...
      >
        <div className="flex flex-col items-center justify-center">
          <div className="flex w-full cursor-pointer flex-col items-center p-[5px] hover:opacity-90">
            {' '}
            <div
            ...
            >
              ...
              {listing?.is_available === false && (
                <div className="absolute left-4 top-4 z-50 flex h-[28.41px] w-[106px] items-center justify-center rounded-[5px] bg-black">
              ...
              <div
                className={`absolute right-2 top-2 flex flex-col gap-2 transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-100 lg:opacity-0'} z-50`}
              >
                <button className="cursor-pointer rounded-full bg-white p-2 shadow-md transition-colors duration-200 hover:bg-gray-100">
              ...
              > */}
              <div className="h-[322px] min-w-[295px] overflow-hidden rounded-[4px]">
                <ImageComponent

  ...
  return (
    <div className="mb-4">
      ...
      <div
        ...
        className={twMerge(
          'w-full cursor-pointer rounded-lg border-[1.5px] p-6 text-center text-sm text-[#3D3D3D] md:w-[272px]',
      ...
      >
        ...
        />
        <Image
          src={uploadedDetails ? '/assets/admission/file_upload_states.svg' : '/assets/admission/iconframe.svg'}
          width={48}
          height={48}
          alt="upload"
          className="mx-auto"

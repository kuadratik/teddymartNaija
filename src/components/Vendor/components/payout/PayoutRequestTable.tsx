import {Button, Form, Pagination, Space, Tooltip} from 'antd'
    ...
    return [
      ...
      },
      {
        ...
        title: (
          <Tooltip
            placement="top"
            title="Payouts are calculated based on your product price (after any discounts), not the EKI display price."
          >
        ...
        render: (text: string, record: any) => (
          <TextComponent as="p" className="flex items-center text-black">
            <FormatNumberCurrency value={+record.payout_amount || 0} currency={isActiveUser?.currency} />
          </TextComponent>
        )
      },

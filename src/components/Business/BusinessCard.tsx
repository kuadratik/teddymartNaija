import {newFormatPhoneNumberByCountry} from '@/utils/fx'
        ...
        >
          <div className="flex items-center">
            ...
            <div style={{padding: 8}} className="pl-3">
              ...
              {business?.website_link && business?.show_website_link ? (
          ...
          <div className="">
            <p className="pt-5 text-[20px] font-bold">
              {' '}
              <p className="text-[10px] font-medium">{business?.owner_name ?? '-'}</p>
            </p>
            <p className="text-[10px] capitalize">{business?.owner_role ?? '-'}</p>
          </div>
          <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1">
            <>
              {business?.business_email && business?.show_business_email && (

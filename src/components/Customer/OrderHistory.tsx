...
interface ItemDetails {
  ...
  variantId?: number
  variantName?: string
  listing?: {weight?: number | string} | null
}
          ...
          {orders.length > 0 ? (
            activeTab === 1 ? (
              <div className="mt-5 w-full">
                {/* Table Header */}
                <div className="grid grid-cols-4 justify-between gap-2 gap-y-1 bg-gray-100 p-2 text-xs font-medium md:grid-cols-8 md:gap-3 lg:text-sm">
                  ...
                  <div className="col-span-2 text-center md:col-span-1 md:text-left">Action</div>
                </div>
                          ...
                          <div key={idx}>
                            ...
                            {item.items.map(subItem => {
                              ...
                              return (
                                <div
                                  key={subItem.id}
                                  className="grid grid-cols-4 flex-nowrap items-center gap-2 overflow-x-auto border-b bg-[#F6F6F6] py-4 pl-3 md:grid-cols-8 md:gap-3"
                                >
                                  ...
                                  <div className="whitespace-nowrap font-normal text-gray-700">
                                    {subItem?.listing?.weight ? `${subItem.listing.weight} g` : 'N/A'}
                                  </div>

                                  <div className="hidden whitespace-nowrap font-normal text-gray-700 md:block">
                                  ...
                                  <div className="hidden whitespace-nowrap text-sm text-gray-600 md:block">
                                    {subItem.date}
                                  </div>
                                  ...
                                  <div className="col-span-2 md:col-span-1">
                                    <Button
                                      ...
                                      type="primary"
                                      size="small"
                                      className="w-full bg-black text-white md:w-auto"

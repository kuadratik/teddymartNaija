...
const SingleAdvertCardProfile = ({
  ...
  return (
    <div className="flex h-full flex-col rounded-[12.69px] border border-[#EAECEF] p-[10px]">
      ...
      <>
        ...
        {isReferralModalOpen && (
          <ReferralModal
            ...
            referralLink={`${baseUrl}/auth/sign-up?redirect=%2Fpost-ad&referral_code=${isAuthenticatedUser?.referral_code}&referralType=ad_lister`}
            formValues={''}
            setFormValues={() => {}}

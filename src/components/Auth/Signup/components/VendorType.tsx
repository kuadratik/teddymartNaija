    ...
    <div className="mb-[200px]">
      <div className="mt-[50px] flex flex-col gap-2">
        ...
        <TextComponent as="span" className="text-sm">
          Select an option and click the continue button
        </TextComponent>
      </div>
      ...
      <div className="mt-[26px] flex flex-col gap-6">
        <CustomButton
          ...
          onClick={() => {
            if (!values.offers_product && values.offers_service) {
              setFieldValue('offers_product', !values.offers_product)
              setFieldValue('offers_service', false)
            } else {
              setFieldValue('offers_product', !values.offers_product)
            }
          }}
        ...
        <CustomButton
          ...
          onClick={() => {
            if (!values.offers_service && values.offers_product) {
              setFieldValue('offers_service', !values.offers_service)
              setFieldValue('offers_product', false)
            } else {
              setFieldValue('offers_service', !values.offers_service)
            }
          }}

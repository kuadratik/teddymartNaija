      ...
      <div className="flex flex-col">
        ...
        <Form onFinish={handleSubmit} layout="vertical" size={'large'}>
          <div className="mb-[24px] flex flex-col gap-5">
            ...
            >
              <TextComponent as="span" className="cursor-pointer text-right text-[13px] leading-[19px] underline">
                Forgot Password?
              </TextComponent>
            </span>
          </div>
        ...
        <div className="mt-3 flex w-full items-center justify-center">
          <div id="google-exist-parent-button" className="flex w-full items-center justify-center">
            <CustomButton
              onClick={() => {}}
              className="mt-4 flex w-full items-center justify-center gap-2 !rounded-lg border-[2px] border-gray-200 bg-white p-2 text-gray-400 md:w-[60%]"
            >

import AdvertComponent from '@/components/Customer/Advert/index'
...
import TeddyAdvertMobile from './components/TeddyAdvertMobile'
import OldAdvert from './components/OldAdvert'

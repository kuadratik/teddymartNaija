...
import VendorLogo from './components/Logo'
...
import {maskEmail} from '../Signup/utils'
...
const LandingPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-8">
      {isDesktop && (
        <div className="fixed top-0 z-50 flex h-[78px] w-full items-center bg-[#222222]">
          <div className="mx-auto flex w-full max-w-7xl items-center justify-between">
            <Image src={'/assets/WhiteLogo.svg'} alt="logo" width={66} height={36} />
      ...
      <div className="w-full md:mt-20 lg:relative lg:mx-auto lg:max-w-[735px]">
        {isDesktop && (
          <div className="absolute left-4 top-1/2 z-40 flex h-[20px] w-[87px] -translate-y-1/2 items-start justify-start border-r border-r-gray-300 pr-[13px]">
                ...
                <Menu className="flex flex-col gap-1">
                  {typeOptions.map((option, index) => (
                    <p
                      ...
                      className="cursor-pointer rounded-lg p-2 visited:text-[#27104E]"
                    >
                      {option.label}
                    </p>
                  ))}
            ...
            >
              <div className="flex h-[24px] flex-row items-center gap-2 font-inter text-sm font-medium text-[#33357D] cursor-pointer">
        ...
        <TextInput
          ...
          placeholder={
            type.toLowerCase() === 'product' ? `Search for a ${type} or vendor` : `Search for a ${type} or provider`
          }
          onChange={e => {
      ...
      <div className="w-full max-w-7xl lg:mx-auto lg:flex lg:h-[400px] lg:items-center lg:gap-5">
        ...
        {isDesktop && (
          <div className="h-full w-[78%] rounded-[13px]">
            <Swiper
              pagination={true}
                    ...
                    >
                      ...
                      <div className="">
                        <CustomButton
                          ...
                          onClick={() => {
                            router.push(`/category/${banner?.redirect_id}`)
                          }}
                        >
                          <TextComponent
                            style={
      ...
      {isDesktop && (
        <div className="mt-[50px] flex h-[78px] w-full items-center justify-center bg-[#222222]">
          <TextComponent as="span" className="text-[13px] font-medium leading-[17px] text-white">
            TeddyMart-2024
          </TextComponent>
        </div>
      )}

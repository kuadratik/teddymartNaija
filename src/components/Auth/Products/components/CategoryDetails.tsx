...
const CategoryDetails = ({
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="grid w-full grid-cols-4 gap-4 lg:grid-cols-5">
        {AllCategories?.filter((category: CategoriesProps) =>
          ...
          <Link
            ...
            key={i}
            className="flex cursor-pointer flex-col items-center gap-2 transition-all delay-75 duration-75 hover:opacity-70"

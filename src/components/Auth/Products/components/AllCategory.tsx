...
const AllCategory = ({open, setOpen, setSelectedCategories, isShowServiceProductCategories = true}: ICategoryProps) => {
  ...
  const {data, isLoading} = useGetAllCategoriesQuery({
    type: isShowServiceProductCategories ? type : undefined
  })

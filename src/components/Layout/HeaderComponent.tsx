      ...
      <div className="flex w-full flex-col items-center justify-center gap-8">
        {!isDesktop ? (
          isAuth && has_store ? (
              ...
              <div className="flex flex-row gap-2">
                ...
                <Button
                  ...
                  icon={
                    <Badge
                      count={data?.data?.total_product_count}
                      style={{backgroundColor: '#000', color: '#fff', fontSize: '16px', fontWeight: 600}}
                    >
                      <Icon icon={'mdi-light:cart'} className="text-[28px] text-black" />
                    </Badge>
                  }
                />
                <CountrySelect />
            ...
            <div className="fixed top-0 z-50 flex w-full items-center justify-between bg-white px-5 py-5">
              <div>
                {' '}
                <LogoHeader />
              </div>

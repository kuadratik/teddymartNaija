  ...
  return (
    <Layout style={{minHeight: '100vh', display: 'flex', flexDirection: 'column', overflowX: 'hidden'}}>
      <div className="pb-[75px]">
        <Header
          className="fixed top-0 z-50 flex w-full justify-between px-5"
          style={{
            height: '78px',
            backgroundColor: '#000',
            display: '',
                  ...
                  {isAuth ? (
                    ...
                    <div className="flex gap-4">
                      <CustomButton
                        ...
                        type="button"
                        className="rounded-lg bg-[#fff] px-7 py-2 text-base text-black"
                      >
                      ...
                      <CustomButton
                        ...
                        type="button"
                        className="whitespace-nowrap rounded-lg !border-[1px] !border-white bg-[#000] px-7 py-2 text-base text-white"
                      >
                        Login
                      </CustomButton>
                    </div>
                  ...
                  {isAuth ? (
                    ...
                    <div className="flex flex-col gap-3">
                      <CustomButton
                        ...
                        type="button"
                        className="w-full whitespace-nowrap rounded-lg bg-[#fff] p-6 py-3 text-base font-medium text-black"
                      >
                        {/* <Icon icon="ic:round-logout" className="text-base" /> */}
                      ...
                      <CustomButton
                        ...
                        type="button"
                        className="w-full whitespace-nowrap rounded-lg bg-[#000] p-6 py-3 text-base font-medium text-white"
                      >

  ...
  return (
    <header className="fixed top-1 z-50 w-full sm:top-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden items-center gap-3 lg:flex">
            {/* <button
              ...
              className={`rounded-full px-4 py-2 text-[14px] font-normal transition-colors ${currentTab === 'navigation' ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-50'
                }`}
            >
              Navigation Bar
            </button> */}
            <button
              ...
              className={`rounded-full px-5 py-2 text-[14px] font-medium transition-colors ${currentTab === 'brands' ? 'bg-black text-white' : 'bg-white text-gray-700 hover:bg-gray-100'
                }`}
            >
              Brands
            </button>
            {/* <button
              ...
              className={`rounded-full px-4 py-2 text-[14px] font-normal transition-colors ${currentTab === 'users' ? 'bg-black text-white' : 'text-gray-700 hover:bg-gray-50'
                }`}
            >
              User Management
            </button> */}
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex lg:hidden">
              ...
              >
                <Icon icon="heroicons:bars-3" className="text-xl sm:text-2xl" />
              </button>
            </div>
          </div>
        </div>
      ...
      >
        ...
        {/* Drawer */}
        <aside
          className={`absolute right-0 top-0 h-full w-80 max-w-[90vw] transform bg-white shadow-xl transition-transform duration-300 ease-in-out ${mobileOpen ? 'translate-x-0' : 'translate-x-full'
            }`}
        >
          {/* Header */}
          <div className="flex items-center justify-between border-b border-gray-100 px-4 py-4">
            <div className="flex items-center gap-2">
              <VendorLogo />
              <div className="flex flex-col">
                <p id="mobile-menu-title" className="text-sm font-semibold">myEKI</p>
          ...
          <div className="flex-1 px-4 py-4">
            <nav className="space-y-2">
              <button
                ...
                className={`flex w-full items-center rounded-lg px-4 py-3 text-left text-sm font-medium transition-colors ${currentTab === 'navigation'
                  ? 'bg-black text-white'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
              >
                <Icon icon="heroicons:bars-3-bottom-left" className="mr-3 text-lg" />
                Navigation Bar
              </button>
              ...
              <button
                ...
                className={`flex w-full items-center rounded-lg px-4 py-3 text-left text-sm font-medium transition-colors ${currentTab === 'brands'
                  ? 'bg-black text-white'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
              >
                <Icon icon="heroicons:building-storefront" className="mr-3 text-lg" />
                Brands
              </button>
              ...
              <button
                ...
                className={`flex w-full items-center rounded-lg px-4 py-3 text-left text-sm font-medium transition-colors ${currentTab === 'users'
                  ? 'bg-black text-white'
                  : 'text-gray-700 hover:bg-gray-50'
                  }`}
              >
                <Icon icon="heroicons:users" className="mr-3 text-lg" />
                User Management
              </button>
            </nav>
          </div>

...
import {Button, Checkbox, Form, Image, Table, Tooltip} from 'antd'
...
import {DeleteOutlined, MinusSquareFilled, PlusSquareFilled} from '@ant-design/icons'
import {Icon} from '@iconify/react'
import useEditProductQuantity from './hooks/useEditProductQuantity'
import HeartImage from '../../../public/assets/heart.svg'
import {sliceText} from '@/utils/fx'
import Popularproduct from '../Auth/Products/components/Popularproduct'
  ...
  const columns = [
    {
      ...
      dataIndex: 'reference',
      key: 'reference',
      render: (text: string) => <span className="w-[50px]">{text.toUpperCase()}</span>
    }
  ]
  ...
  return (
    <React.Fragment>
      {!clipProductInfo?.length ? (
        ...
        //   {allClipsIsSuccess &&
        //     clipProductInfo?.map((info: any, id: any) => {
        //       return (
        ...
        <div className="flex flex-col justify-between gap-4 md:justify-normal lg:mx-auto lg:w-full lg:max-w-7xl">
          ...
          <div className="mt-[60px] w-full space-y-4 lg:flex lg:gap-4">
            {isDesktop && (
                        ...
                        <tr key={id} className="border-b">
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div>
                                ...
                                <TextComponent as="p" className="text-sm text-gray-500">
                                  <Tooltip title={product.description}>{sliceText(product.description, 30)}</Tooltip>
                                </TextComponent>
                          ...
                          <td className="px-4 py-4">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="mx-2 text-[10px] leading-[12px]">{product.quantity}</span>
                              <button
                                className=""
                                onClick={() => {
                                  handleEditProduct({
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              >
                                {addToWishlistLoading ? (
                                  ...
                                  <span className="text-[10px] leading-[13px] text-white">Save for later</span>
                                )}
                                <Image
            ...
            <div className="mt-6 flex w-full flex-col gap-[28px] bg-[#F1F1F1] p-5 lg:w-[40%] lg:rounded-[11px]">
              ...
              <div>
                <Checkbox
                  ...
                  // checked={scalesData.use_accommodation}
                >
                  <TextComponent as="span" className="text-[10px] font-medium leading-[13px] text-[#404040]">
                    I agree with the{' '}
                    <TextComponent as="span" className="text-[10px] font-medium leading-[13px] text-black underline">

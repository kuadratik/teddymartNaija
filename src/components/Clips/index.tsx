                          ...
                          <tr key={id} className="border-b">
                            ...
                            <td className="px-4 py-4">
                              <TextComponent as="p" className="text-[13px] leading-[16px] text-[#6B7280]">
                                <FormatNumberCurrency value={product?.display_price} />
                              </TextComponent>
                            </td>
                            <td className="px-4 py-4">
                              ...
                              <div className="flex items-center justify-between">
                                <TextComponent as="p" className="text-[13px] leading-[16px] text-[#6B7280]">
                                  <FormatNumberCurrency
                                    value={Number(product.display_price) * Number(product.quantity)}
                                  />
                                </TextComponent>
                              </div>
                            </td>
                              ...
                              <div className="flex items-center space-x-2">
                                ...
                                >
                                  {addToWishlistLoading ? (
                                    ...
                                    <span className="text-[10px] leading-[13px] text-white">Add to wishlist</span>
                                  )}
                                  <Image

...
const ClipsComponent = () => {
  ...
  // })
  // Create a wrapper function to handle wishlist loading state per product
  const handleAddToWishlist = (product: any) => {
    ...
    handleAddToWishListCart(product.slug, {
      variant_id: product?.variant?.id || undefined
    }).finally(() => {
      // Remove product identifier from loading list when finished
